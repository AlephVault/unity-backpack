            ...
            namespace Inventory
            {
                namespace Items
                {
                    namespace RenderingStrategies
                    {
                        ...
                        ///     to the quantity).
                        /// </summary>
                        [CreateAssetMenu(fileName = "NewInventoryItemIconTextRenderingStrategy", menuName = "Aleph Vault/BackPack/Inventory/Item Strategies/Rendering/Icon & Text", order = 101)]
