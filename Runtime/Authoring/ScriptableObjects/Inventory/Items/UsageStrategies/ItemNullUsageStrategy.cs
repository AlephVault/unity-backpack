            ...
            namespace Inventory
            {
                namespace Items
                {
                    namespace UsageStrategies
                    {
                        ...
                        /// </summary>
                        [CreateAssetMenu(fileName = "NewInventoryItemNullUsageStrategy", menuName = "Aleph Vault/WindRose/Inventory/Item Strategies/Usage/Null Usage (e.g. tokens, critical objects)", order = 101)]
