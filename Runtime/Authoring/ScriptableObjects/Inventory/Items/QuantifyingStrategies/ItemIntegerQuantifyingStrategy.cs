            ...
            namespace Inventory
            {
                namespace Items
                {
                    namespace QuantifyingStrategies
                    {
                        ...
                        ///   </para>
                        /// </summary>
                        [CreateAssetMenu(fileName = "NewInventoryItemIntegerQuantifyingStrategy", menuName = "Aleph Vault/BackPack/Inventory/Item Strategies/Quantifying/Integer-Stacked", order = 101)]
