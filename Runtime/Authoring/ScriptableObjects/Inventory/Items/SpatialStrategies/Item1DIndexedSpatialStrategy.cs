            ...
            namespace Inventory
            {
                namespace Items
                {
                    namespace SpatialStrategies
                    {
                        ...
                        /// </summary>
                        [CreateAssetMenu(fileName = "NewInventoryItem1DIndexedSpatialStrategy", menuName = "Aleph Vault/BackPack/Inventory/Item Strategies/Spatial/1D Indexed", order = 101)]
